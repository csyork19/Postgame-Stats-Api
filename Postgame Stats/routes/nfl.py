...
def get_nfl_player_season_stats(request) -> 'flask.Response':
...
@handle_exceptions
@with_json(required_fields=["playerName", "season", "seasonType"])
def get_nfl_player_rushing_season_stats(request) -> 'flask.Response':
    player_name = request['playerName']
    season = request['season']
    seasonType = request['seasonType']
...
@handle_exceptions
@with_json(required_fields=["playerName", "season", "seasonType"])
def get_nfl_player_receiving_season_stats(request) -> 'flask.Response':
    player_name = request['playerName']
    season = request['season']
    seasonType = request['seasonType']
...
def get_nfl_pbp_team_season_stats(request) -> 'flask.Response':
